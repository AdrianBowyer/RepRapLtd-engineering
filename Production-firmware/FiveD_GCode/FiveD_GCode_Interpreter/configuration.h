...
#define X_STEPS_PER_MM   91.428 // T2.5 + 14 tooth pulley
//#define X_STEPS_PER_MM   80.376  // T5 + 8 tooth pulley
//#define X_STEPS_PER_MM   49.462
#define X_STEPS_PER_INCH (X_STEPS_PER_MM*INCHES_TO_MM) // *RO
#define INVERT_X_DIR 0

#define Y_STEPS_PER_MM   91.428 // T2.5 + 14 tooth pulley
//#define Y_STEPS_PER_MM   80.376 // T5 + 8 tooth pulley
//#define X_STEPS_PER_MM   49.462
#define Y_STEPS_PER_INCH (Y_STEPS_PER_MM*INCHES_TO_MM) // *RO
#define INVERT_Y_DIR 0
...
// Set to 1 if enable pins are inverting
// The Sanguinololu has inverting enable pins.
...
// Default value: 3; Use bigger values for lower thermal mass extruders.
